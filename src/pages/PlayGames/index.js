...
const GAME_LIST = [
  ...
  /*  {
    ...
    subTitle:
      'Trải nghiệm game show truyền hình "Ai là triệu phú" phiên bản tiếng Anh ngay với Mynary',
  ...
  },
  {
    title: 'Nối từ',
    subTitle:
      'Cùng bắt trend nối từ đã từ rầm rộ trên mạng xã hội với My nhé. Đặc biệt, bạn có thể chơi cùng bạn bè nhé 😮',
    imgUrl: jigsawIcon,
    to: GAMES.JIGSAW,
  },
  {
  ...
  /*   {
    title: 'Game VIP',
    subTitle:
      'Tận hưởng một game cực kỳ tuyệt vời của My nhé, nâng cấp tài khoản VIP để chơi.',
    imgUrl: vipIcon,
    to: GAMES.VIP,
  }, */
];
